...
class Photo extends Db_object{
    ...
    protected static $db_table_fields = array("photo_id", "title", "caption" , "description", "filename", "type", "size" , "alternate_text");
    public $id;
    public $title;
    public $description;
    public $filename;
     ...
     public function picture_path()
    {
        ...
        public function save (){
            ...
            public static function dispaly_sidebar_data($photo_id){

                $photo = Photo::find_by_id($photo_id);

                $output = "<a class='thumbnail' hfer='#'><img src='{$photo->picture_path()}'></a>";
